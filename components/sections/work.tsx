            ...
            return (
              ...
              >
                <div className="relative aspect-3/4 w-full overflow-hidden bg-white/5">
                  ...
                  <div
                    aria-hidden
                    className="pointer-events-none absolute inset-x-0 bottom-0 h-2/5 bg-linear-to-t from-black/80 via-black/35 to-transparent transition-opacity duration-500 group-hover:opacity-0"
                  />

                  {/* Resting label */}
                  <div className="absolute inset-x-0 bottom-0 p-5 transition-all duration-500 ease-out group-hover:pointer-events-none group-hover:translate-y-3 group-hover:opacity-0 md:p-6">
                  ...
                  <div className="pointer-events-none absolute inset-0 flex flex-col justify-end bg-black/55 p-5 opacity-0 backdrop-blur-[2px] transition-opacity duration-500 ease-out group-hover:pointer-events-auto group-hover:opacity-100 md:p-6">
                    ...
                    <div className="mt-5 flex items-center gap-3">
                      ...
                      >
                        <span className="inline-flex items-center justify-center" aria-label={`${project.title} on GitHub`}>
